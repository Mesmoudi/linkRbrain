	...
	class QueryPDF extends PDF {
		...
		function PageGroups(){
			...
			foreach ($groups as $g=>$group){
				...
				if ($hasGenes){
					$this->Write(4, "The genetic surexpression localization have been extracted from the Allen Foundation human brain atlas (http://help.brain-map.org/display/humanbrain/Documentation).");
					$this->Write(8, "\n\n");
				}
				//	Points
				$this->SetFont("Ubuntu", "", 8);
